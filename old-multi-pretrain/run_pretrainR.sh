...
# 创建日志目录
LOG_DIR="$SCRIPT_DIR/checkpoints_pretrain_random/logs"
mkdir -p "$LOG_DIR"

# 生成日志文件名（包含时间戳）
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
LOG_FILE="$LOG_DIR/pretrain_random_${TIMESTAMP}.log"
